...
public class Constants {
     ...
     * График работы
     */
    public static String SHEDULE = "Адрес приюта: Камергерский пер., 5/6, стр. 4, Москва, 125009. \n " +
    ...
    public static String WARNING_NO_DESCRIPTION = "Добавьте описание, чтобы завершить отчет о вашем питомце! Иначе отчет не сохранится!";
    public static String WARNING_REPORT_NOT_CORRECT = "Дорогой усыновитель, мы заметили, что ты заполняешь отчет не так подробно, как необходимо. \n " +
